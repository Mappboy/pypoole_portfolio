    ...
    render={data => {
      ...
      return (
        <ReactHelmet>
          ...
          <script defer src="https://use.fontawesome.com/releases/v5.6.3/js/brands.js" integrity="sha384-VLgz+MgaFCnsFLiBwE3ItNouuqbWV2ZnIqfsA6QRHksEAQfgbcoaQ4PP0ZeS0zS5" crossOrigin="anonymous" />
        </ReactHelmet>
      );
    }}
  />
